...
# 	pp.close();
# 
# def cycle_persistence_distribution(Gen_dict,tag=' ',nbins=100):
# 	import networkx as nx;
# 	import matplotlib.pyplot as plt
# 	persistence=[];
# 	for cycle in Gen_dict:
# 		persistence.append(float(cycle.persistence_interval()));
# 	plt.figure();
# 	# the histogram of the data
# 	n, bins, patches = plt.hist(persistence, nbins, normed=1, facecolor='green', alpha=0.75)
# 	if tag!=' ':
...
# 	plt.figure();
# 	n, bins, patches = plt.hist(length_cycles, nbins, normed=1, facecolor='green', alpha=0.75)
# 	if tag!=' ':
# 		plt.savefig(tag+'_cycle_length_distribution.png');
# 	return n, bins
# 
# def cycle_start_distribution(Gen_dict,tag=' ',nbins=100):
# 	import networkx as nx;
# 	import matplotlib.pyplot as plt
# 	start_cycles=[];
# 	for cycle in Gen_dict:
# 		start_cycles.append(float(cycle.start));
# 	plt.figure();
# 	n, bins, patches = plt.hist(start_cycles, nbins, normed=1, facecolor='green', alpha=0.75)
# 	if tag!=' ':
...
# 		list_comms=list(set(list_comms));
# 		cycle_spread.append(len(list_comms));
# 	return cycle_spread;
# 	
# 			
